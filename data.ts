/*
This is a slightly out-of-date version of UVDOT's data.ts file.
I'm was using it to test the auto-detect feature, but decided to keep it in this commit so we can use it for later testing.
*/
const $: any = {} // dummy data to stop the jQuery functions from erroring out

/**
 * Gets the speeds of all the methods of transit.
 * Also used to make sure the program doesnt pick up on other variables.
*/
...
//! Please read the entire technical.md file before attempting to edit the vars below
//! I would prefer you make an issue on the github or contact us if you want something added
